...
export function _ProductImportModal({
  ...
  const handleDownloadTemplate = useCallback(async () => {
    try {
      ...
      // Sheet 1: Template
      const dataSheet = workbook.addWorksheet('Ítems', {
      ...
      titleCell.value = 'Instrucciones para Importar Ítems';
      ...
      const instructions = [
        {
          ...
          points: [
            'Código: Código único del ítem (SKU). Si el código ya existe, se actualizará el ítem.',
        ...
        },
        {
          ...
          points: [
            ...
            'Código de Barras: Código EAN/UPC del ítem.',
            'Marca: Marca del ítem.',
            'Modelo: Modelo del ítem.',
          ],
        },
        {
          title: '3. Comportamiento',
          points: [
            'Si el código ya existe en el sistema, el ítem se ACTUALIZA con los nuevos datos.',
            'Si el código no existe, se CREA un nuevo ítem.',
      ...
      saveAs(blob, 'plantilla-importacion-items.xlsx');
    } catch (error) {
  ...
  const handleFileUpload = useCallback(
    async (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        ...
        if (rows.length === 0) {
          toast.error('El archivo no contiene ítems para importar');
          return;
        }
  ...
  const importMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast.error(
        error instanceof Error ? error.message : 'Error al importar ítems'
      );
    },
  });
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === 'upload' && 'Subí un archivo Excel (.xlsx) con los ítems a importar.'}
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="rounded-lg border border-dashed p-6 text-center space-y-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Luego subí el archivo completado con tus ítems
                </p>
              </div>
              <div>
                <input
            ...
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-muted-foreground">
                  Se procesaron los ítems correctamente.
                </p>
              </div>
            </div>
            ...
            <div className="flex w-full justify-between">
              ...
              >
                {importMutation.isPending ? (
                  ...
                  <>
                    <Upload className="h-4 w-4 mr-2" />
                    Importar {validRows.length} ítems
                  </>
                )}
              </Button>
            </div>
