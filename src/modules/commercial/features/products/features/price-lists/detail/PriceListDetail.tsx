      ...
      <div className="flex flex-1 flex-col gap-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total de Ítems</p>
              ...
              {items.length > 0 && (() => {
                ...
                return recentlyModified.length > 0 ? (
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Ítems modificados</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Precios de Ítems</CardTitle>
            <CardDescription>
              Gestiona los precios de los ítems en esta lista
            </CardDescription>
          </CardHeader>
          <CardContent>
