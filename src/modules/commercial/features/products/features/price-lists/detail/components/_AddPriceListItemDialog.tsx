...
export function _AddPriceListItemDialog({ priceListId }: AddPriceListItemDialogProps) {
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      logger.error('Error al cargar ítems', { data: { error } });
  ...
  const onSubmit = async (data: CreatePriceListItemFormData) => {
    ...
    try {
      ...
      logger.error('Error al agregar ítem', { data: { error } });
      toast.error(error instanceof Error ? error.message : 'Error al agregar ítem');
    } finally {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Agregar Ítem a la Lista</DialogTitle>
          <DialogDescription>
            Selecciona un ítem y asigna su precio
          </DialogDescription>
        </DialogHeader>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder={loading ? 'Cargando...' : 'Seleccionar ítem'} />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
